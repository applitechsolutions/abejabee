      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Categoría</a></li>
            <li><a href="#"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Unidad</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i> Ver Todos</a></li>
            <li><a href="usuarios.php"><i class="fa fa-plus-circle" aria-hidden="true"></i> Nuevo Usuario</a></li>
          </ul>
        </li>
