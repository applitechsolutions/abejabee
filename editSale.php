                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">
                                        ...
                                        guías de remision</h4>
                                </div>
                                <div class="modal-body">
                                    <form role="form" id="form-correlative-guia" name="form-correlative-guia"
...
?>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button id="correlativeCloseGuia" type="button"
                    ...
                    <div class="modal fade" id="modal-noShipment">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form role="form" id="form-correlative-envio" name="form-correlative-envio"
                                        method="post" action="BLL/correlative.php">
                                        <div class="row">
                                            <?php
try {
...
?>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <span class="text-warning w3-small w3-padding-small pull-left">*Debe llenar
                                                los campos obligatorios</span>
                                            <button id="correlativeCloseEnvio" type="button"
                                                class="btn btn-danger w3-round-medium pull-right"
                                                data-dismiss="modal">Cerrar</button>
                                        </div>
                                </div>
                            ...
                            <div class="nav-tabs-custom">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab_1">
                                        <form role="form" id="form-sale" name="form-sale" method="post"
                                            action="BLL/sale.php" novalidate>
                                            <div class="box-body">
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group date">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    id="datepicker" name="dateSale"
                                                                    value="<?php echo date_format($dateStar, 'd/m/Y'); ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-lg-3">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="noRemi"
                                                                name="noRemi" value="<?php echo $sale['noDeliver']; ?>">
                                                            <div class="input-group-btn">
                                                                <button type="button" class="btn bg-info"
                                                                    data-toggle="modal" data-target="#modal-remi"
                                                                    disabled>
...
if ($sale['type'] == 0) {?>
                                                                ...
                                                                <option value="1" selected>Schlenker</option>
                                                                <?php
}
?>
                                                            </select>
...
?>
                                            ...
                                            <div class="box box-success collapsed-box" id="box">
                                                <div class="box-header with-border">
                                                    ...
                                                    <h3 class="box-title">
                                                        <i class="glyphicon glyphicon-shopping-cart"></i> Productos en
                                                        inventario</h3>
                                                            ...
                                                            <tr id="catalogo">
                                                                <td>
                                                                    <img src="img/products/<?php echo $product['picture']; ?>"
                                                                        width="80"
                                                                        onerror="this.src='img/products/notfound.jpg';">
                                                                </td>
                                                                <td>
                                                                    <div class="margin">
                                                                ...
                                                                <td>
                                                                    <div class="form-group margin">
                                                                        <input
                                                                            id="SelectPrecio<?php echo $product['idProduct']; ?>"
                                                                            class="form-control input-sm" type="number"
                                                                            min="0.00" step="0.01"
                                                                            value="<?php echo $product['pharma']; ?>"
                                                                            style="width: 50%;">
                                                                        <select
                                                                            id="SelectPrice<?php echo $product['idProduct']; ?>"
                                                                            class="form-control select2 SelectPrice"
                                                                            style="width: 100%;"
                                                                            id-data="<?php echo $product['idProduct']; ?>">
                                                                            <option value="plus-square"
                                                                                selected="selected">Farmacia: Q.
                                                                ...
                                                                <td>
                                                                    <input class="form-control input-sm" type="number"
                                                                        id="new_<?php echo $product['idProduct']; ?>_descuentoS"
                                                                        name="descuento" min="0.00" step="0.01"
                                                                        value="0.00" style="width: 50%;">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control input-sm" type="number"
                                                                        id="new_<?php echo $product['idProduct']; ?>_cantidadS"
                                                                        name="cantidadXD" min="1" step="1" value="1"
                                                                        max="<?php echo $product['stock']; ?>"
                                                                        style="width: 65%;">
                                                                    <p
                                                                        class="text-green max_<?php echo $product['idProduct']; ?>_stockP">
                                                                        Disp.
                                                                        <?php echo $product['stock']; ?>
                                                                    </p>
                                                                    <input
                                                                        class="max_<?php echo $product['idProduct']; ?>_stock"
                                                                        type="hidden"
                                                                        value="<?php echo $product['stock']; ?>">
                                                                </td>
                                                                <td>
                                                                    <input class="id_producto_agregar" type="hidden"
                                                                        value="<?php echo $product['idProduct']; ?>">
                                                                    <a id="boton" href="#" cost=""
                                                                        data-id="<?php echo $product['idProduct']; ?>"
                                                                        data-tipo="product"
                                                                        class="btn bg-green btn-lg margin agregar_productoS">
...
?>
                                            ...
                                            <div class="box-footer">
                                                <a onclick="tab2()" data-toggle="tab"
                                                    class="btn btn-flat pull-right text-bold">
                                                    <i class="glyphicon glyphicon-forward"></i> Continuar con la
                                                    venta...</a>
                                            </div>
                                    </div>
                                    <!-- /.tab-pane -->
        ...
        $subtotal = ($detailS['priceS'] - $detailS['discount']) * $detailS['quantity'];?>
                                                        <tr id="detalleS">
                                                            ...
                                                            <td><input class="idproducto_class" type="hidden"
                                                                    value="<?php echo $detailS['idProduct']; ?>"><?php echo $detailS['productName']; ?>
                                                            </td>
                                                            ...
                                                            <td><input type="hidden"
                                                                    value="<?php echo $detailS['cost']; ?>">Q.<?php echo $detailS['cost']; ?>
                                                            </td>
                                                            <td><input class="precio_class" type="hidden"
                                                                    value="<?php echo $detailS['priceS']; ?>">Q.<?php echo $detailS['priceS']; ?>
                                                            </td>
                                                            <td><input class="cantidad_class" type="hidden"
                                                                    value="<?php echo $detailS['quantity']; ?>"><?php echo $detailS['quantity']; ?>
                                                            </td>
                                                            <td><input class="descuento_class" type="hidden"
                                                                    value="<?php echo $detailS['discount']; ?>">Q.<?php echo $detailS['discount']; ?>
                                                            </td>
                                                            <td>Q.<?php echo $subtotal; ?></td>
                                                            <td><a id="quitar"
                                                                    onclick="eliminarS(<?php echo $detailS['idProduct']; ?>);"
                                                                    data-id-detalle="<?php echo $detailS['idProduct']; ?>"
                                                    ...
                                                    <div class="form-group col-lg-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="payment"
                                                                name="payment"
                                                                value="<?php echo $sale['paymentMethod']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-lg-3">
                                                    ...
                                                    <div class="form-group col-lg-6">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="note"
                                                                name="note" value="<?php echo $sale['note']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-lg-6 pull-right">
                                                        ...
                                                        <span class="text-warning">Debe llenar los campos obligatorios*
                                                        </span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="box box-warning">
                                                    <div class="box-header">
                                                        ...
                                                        <a class="btn btn-app pull-right" href="#"
                                                            onclick="generarFactura();">
                                                            <i class="glyphicon glyphicon-save-file"></i> Generar
                                                            Factura
                                                        </a>
                                                    </div>
                                                    <div class="box-body">
                                                        <div id="divreporteF" class="w3-rest">
                                                            <iframe src=""
                                                                style="width: 100%; height: 640px; min-width: 300px;"></iframe>
                                                        </div>
                                                    </div>
                                                    <!-- /.box-body -->
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="box box-warning">
                                                    ...
                                                    <div class="box-body">
                                                        <form role="form" id="form-envio" name="form-envio"
                                                            method="post" action="BLL/sale.php">
                                                            <div class="row">
                                                                <div class="form-group col-md-6">
                                                                    <label for="transport">Transporte</label>
                                                                    <input type="text" class="form-control"
                                                                        id="transport" name="transport"
                                                                        placeholder="Escriba un transporte"
                                                                        value="<?php echo $sale['transport']; ?>"
                                                                        autofocus>
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input type="text" class="form-control"
                                                                            id="noShipment1" name="noShipment1"
                                                                            value="<?php echo $sale['noShipment']; ?>"
                                                                            disabled>
                                                                        <input type="hidden" class="form-control"
                                                                            id="noShipment" name="noShipment"
                                                                            value="<?php echo $sale['noShipment']; ?>">
                                                                        <div class="input-group-btn">
                                                                            <button type="button" class="btn bg-info"
                                                                                data-toggle="modal"
                                                                                data-target="#modal-noShipment">
                                                                                <i class="glyphicon glyphicon-print"
                                                                                    aria-hidden="true"></i>
                                                                                Correlativo
                                                                            </button>
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="noDeliver" name="noDeliver"
                                                                        placeholder="Escriba un número de entrega"
                                                                        value="<?php echo $sale['noShipment']; ?>">
                                                                </div>
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <br>
                                                                    <span class="text-warning"><small>*Si no ingresa un
                                                                            número de entrega se almacenará el número de
                                                                            envio</small></span>
                                                                </div>
                                                            </div>
                                                            <!-- /.box-body -->
                                                    ...
                                                    <div id="divreporteE" class="w3-rest">
                                                        <iframe src=""
                                                            style="width: 100%; height: 470px; min-width: 300px;"></iframe>
                                                    </div>
                                                </div>
                                                <!-- /.box-body -->
                                            </div>
