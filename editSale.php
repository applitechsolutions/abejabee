    ...
    FROM product P WHERE state = 0 AND (select sum(stock) from storage where _idProduct = P.idProduct AND _idCellar = 1) > 0 ORDER BY productCode ASC";
                              ...
                              while ($product = $resultado->fetch_assoc()) {
                                ...
                                <tr id="catalogo">
                                  ...
                                  <td>
                                    <input class="form-control input-sm" type="number" id="new_<?php echo $product['idProduct']; ?>_cantidadS" name="cantidadXD" min="1" step="1" value="1" max="<?php echo $product['stock']; ?>" style="width: 65%;">
                            ...
                            try {
                              ...
                              while ($detailS = $resultado->fetch_assoc()) {
                                ...
                                <tr id="detalleS">
                                  ...
                                  <td><a id="quitar" onclick="eliminarS(<?php echo $detailS['idProduct']; ?>);" data-id-detalle="<?php echo $detailS['idProduct']; ?>" class="btn bg-maroon btn-flat margin quitar_product"><i class="fa fa-remove"></i></a></td>
                                </tr>
                              <?php
                              }
                            } catch (Exception $e) {
                            ...
                            <form role="form" id="form-envio" name="form-envio" method="post" action="BLL/sale.php">
                              <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <div class="input-group">
                                    <input type="text" class="form-control" id="noShipment1" name="noShipment1" value="<?php echo $sale['noShipment']; ?>" disabled>
