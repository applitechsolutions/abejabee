            ...
            <div class="box-body">
              <form role="form" id="form-vendedor" name="form-vendedor" method="post" action="BLL/seller.php">
                ...
                <div class="box-footer">
                  ...
                  <button type="submit" class="btn btn-primary pull-left" id="crear-vendedor"><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</button><span class="text-warning">  *Debe llenar los campos obligatorios</span>
                </div>
              </form>
            </div>
            <!-- /.box-body -->
