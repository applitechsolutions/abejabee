              ...
              <form role="form" id="form-vendedor" name="form-vendedor" method="post" action="BLL/seller.php">
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="codigo-vendedor" name="codigo-vendedor" placeholder="Escribe el código del vendedor" value="<?php echo $seller['sellerCode']; ?>">
                  </div>
                  <div class="form-group">
