            ...
            <div class="box-body table-responsive no-padding">
              <table id="registros" class="table table-bordered table-striped w3-small">
                ...
                ?>
                    <tr>
                      <td>
                        <?php echo $customer['customerCode']; ?>
                      </td>
                      <td>
                        <?php echo $customer['customerName']; ?>
                      </td>
                      <td>
                        <?php echo $customer['customerTel']; ?>
                      </td>
                      <td>
                        <?php echo $customer['customerNit']; ?>
                      </td>
                      <td>
                        <?php echo $customer['roName']; ?>
                      </td>
                      <td>
                        <?php echo $customer['customerAddress']; ?>
                      </td>
                      <td>
                        <?php echo $customer['depName']; ?>
                      </td>
                      <td>
                        <?php echo $customer['townName']; ?>
                      </td>
                      <td>
                        <?php echo $customer['villaName']; ?>
                      </td>
                      <td>
