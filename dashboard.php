            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <form role="form" id="form-DASH" name="form-DASH" method="post"
                                action="BLL/dashTotalSales.php">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right datepicker"
                                                id="datepicker2" name="dateDASHE">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <button style="margin-top:27px;" type="submit" class="btn btn-primary pull-right"
                                        id="rpt4"><i class="fa fa-list-alt" aria-hidden="true"></i> Generar
                                        Total</button>
                                </div>
                                    ...
                                    <div class="info-box bg-secondary">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number"><label for="totalS"
                                                    id="totalVentasDASH">0</label></span>
                                        </div>
                                        <!-- /.info-box-content -->
                                    </div>
                                </div>
...
?>
                                    ...
                                    <div class="progress sm">
                                        <div class="progress-bar progress-bar-green"
                                            style="width: <?php echo porcentaje($ventasTotal, $ventas['ventas'], 2); ?>%">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.progress-group -->
                                <div class="progress-group">
                                    ...
                                    <div class="progress sm">
                                        <div class="progress-bar progress-bar-red"
                                            style="width: <?php echo porcentaje($ventasTotal, $ventasV['ventasV'], 2); ?>%">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.progress-group -->
...
?>
                                    ...
                                    <div class="progress sm">
                                        <div class="progress-bar progress-bar"
                                            style="width: <?php echo porcentaje($ventasTotal, $ventasPT['ventasPT'], 2); ?>%">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.progress-group -->
...
?>
                                    ...
                                    <div class="progress sm">
                                        <div class="progress-bar progress-bar-yellow"
                                            style="width: <?php echo porcentaje($ventasT['ventasT'] + $ventasPV['ventasPV'], $ventasPV['ventasPV'], 2); ?>%">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.progress-group -->
...
try {
    $sql = "SELECT (select CONCAT(productCode, ' ', productName) from product where idProduct = `_idProduct` ) as product,
                  ...
                  SUM(quantity) FROM `details` D INNER JOIN sale S ON D._idSale = S.idSale
                WHERE state = 0 AND (select state from product where idProduct = _idProduct) = 0
                GROUP BY `_idProduct`ORDER BY SUM(quantity) DESC LIMIT 5";
    $resultado = $conn->query($sql);
} catch (Exception $e) {
    $error = $e->getMessage();
    echo $error;
    ...
    ?>
                            <li class="item">
                                <div class="product-img">
                                    <img src="img/products/<?php echo $product['picture']; ?>" alt="Product Image"
...
$(document).ready(function() {
    ...
    $.notify({
        ...
        title: 'ÚLTIMA ACTUALIZACIÓN... <br>',
        message: '<li>Reporte de ventas por producto</li><li>Reporte del total cobrado</li>',
        url: 'report.php',
        target: '_blank'
    }, {
        // settings
